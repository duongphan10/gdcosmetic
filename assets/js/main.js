...
const URL_SOCKET = 'https://nginx-gdcosmetic.up.railway.app';
...
if (roleId == 1) {
  $("#nav-account").removeClass("d-none").show();
  $("#btnCreate").removeClass("d-none").show();
  $("#btnPay").removeClass("d-none").show();
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  //     maxSize: 6,
  //     maxSpeed: 3,      
  //     flakeCount: 150,        // Số lượng tuyết rơi
  //     flakeColor: 'pink',  // Màu sắc của tuyết
  //     flakeIndex: 999999,
  //   });
  // });   
...
async function showInfo() {
  try {
    ...
    if (response.ok) {
      ...
      $('#full-name').text(data.data.fullName);
      $('#dropdown-full-name').text(data.data.fullName);
      if (data.data.positionName) {
        $('#dropdown-positon').text(data.data.positionName);
      }
